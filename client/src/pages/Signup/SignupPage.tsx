    ...
    <div className="min-h-screen bg-base-200 flex flex-col">
      ...
      <div className="navbar bg-base-100 shadow-sm">
        ...
        <div className="flex-none gap-1">
          ...
          <span className="text-sm text-base-content/60 mr-2">Already have an account?</span>
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="card bg-base-100 shadow-xl w-full max-w-md">
          <div className="card-body">
            {!signupsEnabled ? (
              <>
                <h1 className="text-2xl font-bold mb-1">Signups are currently closed</h1>
                <p className="text-base-content/60 text-sm mb-6">
                  We&rsquo;re not accepting new accounts right now. Check back soon.
                </p>
